...
public class Wordtest {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (true) {
			...
			System.out.println("1) 주관식  2) 객관식  3) 단어 추가 4) 퀴즈 빈출 단어 5) 종료");
			num = sc.nextInt();
			sc.nextLine();
			if (num == 1) {
				Subjective();
	...
	public static void Quiz_words() {
		System.out.print("오름차순으로 할까요 (true/false)입력 : ");
		boolean dd=sc.nextBoolean();
		sc.nextLine();
		System.out.print("몇 개를 출력할까요? : ");
